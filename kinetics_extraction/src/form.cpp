...
Form::~Form() { delete ui; }
QString Form::lineEdit_5() const { return ui->lineEdit_5->text(); }

QString Form::textEdit() const { return ui->textEdit->toPlainText(); }

QString Form::comboBox_2() const { return ui->comboBox_2->currentText(); }

QString Form::comboBox_6() const { return ui->comboBox_6->currentText(); }
QString Form::comboBox_4() const { return ui->comboBox_4->currentText(); }
QString Form::comboBox_8() const { return ui->comboBox_8->currentText(); }

QString Form::lineEdit_4() const { return ui->lineEdit_4->text(); }
...
{
    double b = ui->doubleSpinBox->value();
    return b;
}

double Form::getDoubleSpinBoxValue_2() const
{
    double m = ui->doubleSpinBox_2->value();
    return m;
}
    ...
    if (ui->checkBox->isChecked() && ui->checkBox_3->isChecked()) {
        ...
        for (int i = 0; i < ui->tableWidget->rowCount(); ++i) {
            ...
            if (ui->checkBox_5->isChecked() && ui->tableWidget->item(i, column4)) {
                ...
                // qDebug() << "No data in column4 at row" << i;
            }
        }
...
void Form::setupConnections()
{
    ...
    // ★ 当 comboBox_6 选为“质量”时，自动把 lineEdit_5 填入百分号
...
void Form::onCheckBox3Changed(int state)
{
    if (state == Qt::Checked && ui->checkBox_4->isChecked()) {
        ...
        QMessageBox::warning(this, "警告", "不能同时选择！");
    }
}
