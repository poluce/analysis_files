...
QString TreeItem::curveId() const { return m_curveId; }

QString TreeItem::projectName() const { return m_projectName; }

bool TreeItem::isProjectNode() const { return m_isProjectNode; }
    ...
    , m_rootItem(new TreeItem(""))
{
    ...
    qDebug() << "构造:  CurveTreeModel";

    // 连接信号
    connect(m_curveManager, &CurveManager::curveAdded, this, &CurveTreeModel::onCurveAdded);
    connect(m_curveManager, &CurveManager::curveRemoved, this, &CurveTreeModel::onCurveRemoved);
    connect(m_curveManager, &CurveManager::curvesCleared, this, &CurveTreeModel::onCurvesCleared);

    buildTree();
}

CurveTreeModel::~CurveTreeModel() { delete m_rootItem; }
...
QStringList CurveTreeModel::getCheckedCurveIds() const { return m_checkedCurves.values(); }
