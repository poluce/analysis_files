#include "baseline_command.h"
#include "ui/chart_view.h"
#include <QDebug>
#include <QPen>
#include <QUuid>

BaselineCommand::BaselineCommand(ChartView* plotWidget, const QString& curveId, const QPointF& start, const QPointF& end)
    : m_plotWidget(plotWidget)
    , m_curveId(curveId)
    , m_start(start)
    , m_end(end)
{
    qDebug() << "构造:  BaselineCommand";
    // 生成唯一的基线ID
...
QString BaselineCommand::description() const { return QObject::tr("绘制基线"); }
